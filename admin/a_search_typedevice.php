...
<div id="search" class="container-search100">    
    ...
    <div class="container-pag">
        ...
        if(empty($poisk)) {
            ...
            echo "<a href=a_search_typedevice.php?page=". minus($page) ."> « </a>";
            // Формируем пагинацию
            for ($i = 1; $i <= $str_pag; $i++) {
                echo "<a href=a_search_typedevice.php?page=".$i."> ". active($page, $i) ." </a>";
            }
            echo "<a href=a_search_typedevice.php?page=". plus($page, $str_pag) ."> » </a>";
    ...
    <div class="container-table mtb-3">
        ...
        <form class="create100-form validate-form" action="a_create_typedevice.php" method="POST">
            <div class="container-create100-form-btn">
                <div class="wrap-create100-form-btn">
                    <div class="create100-form-bgbtn"></div>
                        <button id="search-button" class="create100-form-btn">
