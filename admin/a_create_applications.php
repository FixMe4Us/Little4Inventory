    ...
    <div class="limiter">
        <div class="container-create100">
            <div class="wrap-create100">
                <form class="create100-form validate-form" action="a_create_applications_check.php" method="POST">
                    ...
                    <div class="wrap-input100 validate-input" data-validate="ФИО">
                        ...
                        <span class="focus-input100" data-placeholder="ФИО"></span>
                    </div>
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Опишите проблему">
                        ...
                        <span class="focus-input100" data-placeholder="Краткое описание проблемы"></span>
                    </div>
