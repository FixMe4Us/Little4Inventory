...
<div id="search" class="container-search100">    
    ...
    <div class="container-pag">
        ...
        if(empty($poisk)) {
            ...
            echo "<a href=a_search_technique.php?page=". minus($page) ."> « </a>";
            // Формируем пагинацию
            for ($i = 1; $i <= $str_pag; $i++) {
                echo "<a href=a_search_technique.php?page=".$i."> ". active($page, $i) ." </a>";
            }
            echo "<a href=a_search_technique.php?page=". plus($page, $str_pag) ."> » </a>";
                    ...
                    if (empty($poisk)) {
                        while ($row = mysqli_fetch_array($result)) {
                                echo '<tr>' .
                                        ...
                                        "<td><a href='a_update_technique.php?red_id={$row['id_technique']}'><img src='/images/change.png' alt='Change'></a></td>" .
                                    '</tr>';
                                    $count++;
                                }
                        ...
                        $res = mysqli_query($link, $sqllike);
                            ...
                            while ($row1 = mysqli_fetch_array($res)) {
                                echo '<tr>' .
                                        ...
                                        "<td><a href='a_update_technique.php?red_id={$row1['id_technique']}'><img src='/images/change.png' alt='Change'></a></td>" .
                                    '</tr>';
                            }
                    }
                    ?>
