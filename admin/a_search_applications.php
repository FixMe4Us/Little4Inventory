...
<div id="search" class="container-search100">    
    ...
    <div class="container-pag">
        ...
        if(empty($poisk)) {
            ...
            echo "<a href=a_search_applications.php?page=". minus($page) ."> « </a>";
            // Формируем пагинацию
            for ($i = 1; $i <= $str_pag; $i++) {
                echo "<a href=a_search_applications.php?page=".$i."> ". active($page, $i) ." </a>";
            }
            echo "<a href=a_search_applications.php?page=". plus($page, $str_pag) ."> » </a>";
    ...
    <div class="container-table mtb-3">
                    ...
                    if (empty($poisk)) {
                        while ($row = mysqli_fetch_array($result)) {
                                echo '<tr>' .
                                        ...
                                        "<td><a href='a_update_applications.php?red_id={$row['id_applications']}'><img src='/images/change.png' alt='Change'></a></td>" .
                                    '</tr>';
                                    $count++;
                                }
                        ...
                        $res = mysqli_query($link, $sqllike);
                            ...
                            while ($row1 = mysqli_fetch_array($res)) {
                                echo '<tr>' .
                                        ...
                                        "<td><a href='a_update_applications.php?red_id={$row1['id_applications']}'><img src='/images/change.png' alt='Change'></a></td>" .
                                    '</tr>';
                            }
                    }
                    ?>
        ...
        <form class="create100-form validate-form" action="a_create_applications.php" method="POST">
            <div class="container-create100-form-btn">
                <div class="wrap-create100-form-btn">
                    <div class="create100-form-bgbtn"></div>
                        <button id="search-button" class="create100-form-btn">
