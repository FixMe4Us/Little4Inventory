							...
							<ul class="nav__list nav__list--dropdown dropdown-list dropdown-submenu">
								...
								<li class="dropdown-submenu__item">
									...
									<ul class="dropdown-submenu__list">
										<li class="dropdown-submenu__list-item"><a href="m_search_technique.php">Поиск оборудования</a></li>
										<li class="dropdown-submenu__list-item"><a href="m_create_technique.php">Добавить оборудование</a></li>
									</ul>
								</li>
								<li class="dropdown-submenu__item">
									<h3 class="dropdown-submenu__title">Тип оборудования</h3>
									<ul class="dropdown-submenu__list">
										<li class="dropdown-submenu__list-item"><a href="m_search_typedevice.php">Поиск типа оборудования</a></li>
										<li class="dropdown-submenu__list-item"><a href="m_create_typedevice.php">Добавить тип оборудования</a></li>
									</ul>
								</li>
							</ul>
						</li>
					...
					<li class="nav__item">
						...
						<ul class="nav__list nav__list--dropdown dropdown-list dropdown-submenu">
							...
							<li class="dropdown-submenu__item">
								...
								<ul class="dropdown-submenu__list">
									<li class="dropdown-submenu__list-item"><a href="m_search_subdivisions.php">Поиск подразделения</a></li>
									<li class="dropdown-submenu__list-item"><a href="m_create_subdivisions.php">Добавить подразделение</a></li>
								</ul>
							</li>
							<li class="dropdown-submenu__item">
								<h3 class="dropdown-submenu__title">Помещения</h3>
								<ul class="dropdown-submenu__list">
									<li class="dropdown-submenu__list-item"><a href="m_search_room.php">Поиск помещения</a></li>
									<li class="dropdown-submenu__list-item"><a href="m_create_room.php">Добавить помещение</a></li>
								</ul>
							</li>
						</ul>
					</li>
					<li class="nav__item">
						...
						<ul class="nav__list nav__list--dropdown dropdown-list">
							...
							<li class="dropdown-list__item">
								<a href="m_search_applications.php" class="dropdown-list__link">Поиск по заякам</a>
							</li>
							<li class="dropdown-list__item">
								<a href="m_create_applications.php" class="dropdown-list__link">Добавить заявку</a>
							</li>
						</ul>
					</li>
					<li class="nav__item"><a href="m_view_mobile_app.php" class="nav__link">Мобильное приложение</a></li>
