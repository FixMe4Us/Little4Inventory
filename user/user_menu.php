		...
		<div class="container header__container">
			...
			<nav class="nav header__nav">
				<ul class="nav__list">
					...
					<li class="nav__item"><a href="u_create_applications.php" class="nav__link">Создать заявку</a></li>




					<li class="nav__item"><a href="u_view_contacts.php" class="nav__link">Контакты</a></li>
					
					<li class="nav__item"><a href="u_view_mobile_app.php" class="nav__link">Мобильное приложение</a></li>
