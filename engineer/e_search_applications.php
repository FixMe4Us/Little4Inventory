...
<div id="search" class="container-search100">    
    ...
    <div class="container-pag">
        ...
        if(empty($poisk)) {
            ...
            echo "<a href=e_search_applications.php?page=". minus($page) ."> « </a>";
            // Формируем пагинацию
            for ($i = 1; $i <= $str_pag; $i++) {
                echo "<a href=e_search_applications.php?page=".$i."> ". active($page, $i) ." </a>";
            }
            echo "<a href=e_search_applications.php?page=". plus($page, $str_pag) ."> » </a>";
                    ...
                    if (empty($poisk)) {
                        while ($row = mysqli_fetch_array($result)) {
                                echo '<tr>' .
                                        ...
                                        "<td><a href='e_update_applications.php?red_id={$row['id_applications']}'><img src='/images/change.png' alt='Change'></a></td>" .
                                    '</tr>';
                                    $count++;
                                }
                        ...
                        $res = mysqli_query($link, $sqllike);
                            ...
                            while ($row1 = mysqli_fetch_array($res)) {
                                echo '<tr>' .
                                        ...
                                        "<td><a href='e_update_applications.php?red_id={$row1['id_applications']}'><img src='/images/change.png' alt='Change'></a></td>" .
                                    '</tr>';
                            }
                    }
                    ?>
